...
function Step1({ handleSelect, selectedOption, userInfo }) {
  // Check if user has already used the free content
  const hasUsedFreeContent = userInfo?.IsUsedFreeContent || false;
